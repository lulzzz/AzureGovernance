param (
[Parameter(Mandatory=$false)][string]$Currency = 'CHF'  ,
[Parameter(Mandatory=$false)][string]$Locale = 'de-CH'  ,
[Parameter(Mandatory=$false)][string]$RegionInfo = 'CH'  ,
[Parameter(Mandatory=$false)][string]$OfferDurableId = 'MS-AZR-0003P' ,
