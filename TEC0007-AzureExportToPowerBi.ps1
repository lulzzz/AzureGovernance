...
#
###############################################################################################################################################################
workflow TEC0007-AzureExportToPowerBi
{
  [OutputType([object])] 	
...
$TableStatement = 'CREATE TABLE DSCTracking
(ServerName varchar(25) NOT NULL,
DSCGuid char(25) NOT NULL,
Roles varchar(400) NOT NULL,
Applications varchar(400) NOT NULL,
Compliance varchar(400),
Owner varchar(50),
DateAdded datetime,
...
Invoke-Sqlcmd -Database wus-te-sdb-oms01-bi -ServerInstance wus-te-sdb-oms-01.database.windows.net -Username felix -Password Xilef123456$ -OutputSqlErrors $True -Query $TableStatement
...
$TableData = "INSERT INTO DSCTracking VALUES ('hrweb4.contoso.com','79ad26df-4f09-4526-82e1-a849bcb123be','domain;dotnet;web','HRBenefits','HIPPAA;SOX','judy.lew@contoso.com','9/1/14 7:15 AM','9/8/14 6:30 AM','HR server')"

$TableData = "INSERT INTO test VALUES ('aa','bb')"
